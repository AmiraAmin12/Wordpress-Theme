...
<?php 
$homepagesPosts= new WP_Query( array('posts_per_page'=>2,
'post_type'=>'post'));
while( $homepagesPosts->have_posts()){
  $homepagesPosts->the_post();?>
         <div class="event-summary">
            ...
            <div class="event-summary__content">
              <h5 class="event-summary__title headline headline--tiny"><a href="<?php  the_permalink()?>"><?php  the_title()?></a></h5>
              <p><?php  if(has_excerpt()){
  echo get_the_excerpt(); }  else{ echo  wp_trim_words(get_the_content(),18); }?> <a href="<?php  the_permalink()?>" class="nu gray">Read more</a></p>
            </div>
          </div>
          <?php }  wp_reset_postdata();?>
